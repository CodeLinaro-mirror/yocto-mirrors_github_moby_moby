...
// Registration pairs a point id with its client provider. Single carries the
// contract-declared cardinality (see [extensions.DefineSinglePoint]): a host
// treats such a point as admitting one provider and rejects an installation
// with more at startup.
